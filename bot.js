...
client.on("ready", () => {
  function lol() {
    client.guilds.get('504666125372751872').roles.find("name", "Disco").setColor("RANDOM");
  };
  setInterval(lol, 10000);
});
...
client.on("ready", () => {
  function lol() {
    client.guilds.get('500470585134940165').roles.find("name", "Disco").setColor("RANDOM");
  };
  setInterval(lol, 10000);
});
...
client.on("ready", () => {
  function lol() {
    client.guilds.get('486625411728670720').roles.find("name", "Disco").setColor("RANDOM");
  };
  setInterval(lol, 10000);
});
